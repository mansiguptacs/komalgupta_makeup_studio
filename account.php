...
<section class="page-section">
    <div class="container account-page">
        ...
        <?php endif; ?>
        <?php if ($isSiteUser): ?>
            <p class="lead" id="account-lead">Signed in with Our Marketplace as <strong><?php echo htmlspecialchars($siteUser['name']); ?></strong>.</p>
        <?php elseif ($isAdmin): ?>
            <p class="lead" id="account-lead">You are signed in as an administrator.</p>
        <?php else: ?>
            <p class="lead" id="account-lead">Customer accounts use <strong>Our Marketplace</strong> single sign-on. Create an account there if you need one, then sign in here.</p>
        <?php endif; ?>
        ...
        <div class="account-grid">
            ...
            <?php elseif (!$isAdmin): ?>
                <article class="account-card">
                    <h2>Sign in</h2>
                    <p>Use the same Our Marketplace account for this studio site.</p>
                ...
                <article class="account-card">
                    ...
                    <p>Register on Our Marketplace, then return here and use Sign in.</p>
